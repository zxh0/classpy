...
import com.github.zxh.classpy.dexfile.datatype.UByteHex;
...
public class DexReader extends BytesReader {
    ...
    public UByteHex readUByteHex() {
        UByteHex ubyte = new UByteHex();
        ubyte.read(this);
        return ubyte;
    }
    ...
    public Uleb128p1 readUleb128p1() {
        Uleb128p1 uleb = new Uleb128p1();
        uleb.read(this);
        return uleb;
    }
